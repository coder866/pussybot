...
class customfunc
{
    ...
    public static function getTrendingKe(){
       ...
       $tweetText=
        SELF::getRandomZenQuote() . PHP_EOL . "#MasculinitySaturday,#Catarday,#RCTs,#InspiredKitty,#Catvibes,#KittyLove,#BlackBoxThinking,#Kitty,#CatsOfTwitter";
        woeid::create([
            'loc'=>'kenya',
            'tweet'=>$tweetText,
            'status'=>0
